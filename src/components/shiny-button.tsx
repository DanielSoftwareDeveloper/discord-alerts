...
export const ShinyButton = ({
  ...
  return (
    ...
    >
      ...
      <div className="custom-ease absolute -left-[75px] -top-[50px] -z-10 h-[155px] w-8 rotate-[35deg] bg-white opacity-20 transition-all duration-500 group-hover:left-[120%]"/>
    </Link>
  )
}
